...
export default function Form () {
  ...
  const triggerSwitch = (e) => {
    ...
    {
      signUp.style.backgroundColor = "#3571f1"
      signUp.color = "white"
    ...
    {
      signIn.style.backgroundColor = "#3571f1"
      signIn.color = "white"
  ...
  const Switch = () => {
    if (opt) {
      return (
        <form data-aos="fade-up" action='./post' method='post' onSubmit={e => e.preventDefault()}>
  ...
  return (
    <div className='form'>
      <div data-aos="fade-up" className='sub-form'>
      ...
      <div data-aos="fade-up" className='login-form'>
        <div id="sign-opt">
